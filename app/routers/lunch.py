...
OPERATE_MODES = {
    "hire": "จ้างเหมาประกอบอาหาร (ปรุงสำเร็จ) — ร้าน/ผู้รับจ้างทำมาส่ง",
    "person": "จ้างบุคคลประกอบอาหาร (แม่ครัว) — จ้างคนทำ + ซื้อวัตถุดิบให้ครบในตัว",
    "ingredient": "ซื้อวัตถุดิบมาทำเอง ไม่จ้างคน (ยืมเงิน)",
    "self": "โรงเรียนดำเนินการเอง (ไม่ออกเอกสารจัดซื้อจัดจ้าง)",
}
