...
def _menu_table3(doc, menus, third_header):
    ...
    widths = [Cm(3.44), Cm(6.56), Cm(6.2)]   # ช่องวันที่กว้างพอให้วันที่อยู่บรรทัดเดียว (ตามไฟล์)
...
def render_order_doc(rnd, school, doc=None) -> str:
    ...
    if is_person:
        _p(doc, "8. การส่งมอบงานและการจ่ายเงินผู้รับจ้างต้องสรุปรายการประกอบอาหารให้แก่ผู้ว่าจ้างเพื่อทำการ"
                "เบิกจ่ายเงิน จำนวน 1 งวด โดยมีรายละเอียด ดังนี้", align="justify", indent=1)
        _p(doc, f"งวดที่ 1 ผู้รับจ้างต้องสรุปรายการประกอบอาหารให้แก่ผู้ว่าจ้าง ภายใน {days} วัน "
                "นับถัดจากวันลงนามในใบสั่งจ้าง", align="justify", indent=1.25, after=0)
    else:
