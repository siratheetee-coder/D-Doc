...
def render_tor_doc(rnd, school, doc=None) -> str:
    ...
    _p(doc, f"ผู้รับจ้างต้องเป็นผู้รับผิดชอบการประกอบอาหารกลางวัน (ปรุงสำเร็จ) {period} ให้แก่นักเรียน "
            ...
            "ประกอบอาหารกลางวันในทุกวันทำการ ตามรายการอาหารที่โรงเรียนกำหนด ทั้งนี้ คณะกรรมการตรวจรับงานจ้าง "
            "หรือผู้ตรวจรับงานจ้างจะเป็นผู้แจ้งรายการอาหารให้ผู้รับจ้างทราบก่อนประกอบอาหารอย่างน้อย 5 วันทำการ",
       align="justify", indent=1)
    ...
    if insts:
        ...
        _p(doc, "โรงเรียนกำหนดการจ่ายเงินเป็นงวดตามการส่งมอบและผ่านการตรวจรับของคณะกรรมการตรวจรับงานจ้าง",
           align="justify", indent=1)
