...
def render_order_doc(rnd, school, doc=None) -> str:
    ...
    _p(doc, "๓. สงวนสิทธิ์ค่าปรับกรณีส่งมอบเกินกำหนด โดยคิดค่าปรับเป็นรายวันในอัตราร้อยละ ๐.๒๐ "
            "ของมูลค่าตามใบสั่งจ้าง แต่จะต้องไม่ต่ำกว่าวันละ ๑๐๐ บาท", align="justify", indent=1.25)
    _p(doc, "๔. ส่วนราชการสงวนสิทธิ์ที่จะไม่รับมอบ ถ้าปรากฏว่างานจ้างนั้นมีลักษณะไม่ตรงตามรายการที่ระบุไว้"
            "ในใบสั่งจ้าง กรณีนี้ผู้รับจ้างต้องดำเนินการเปลี่ยนใหม่ให้ถูกต้องตามใบสั่งจ้างทุกประการ",
       align="justify", indent=1.25)
    _p(doc, "๕. ผู้รับจ้างจะต้องไม่เอางานทั้งหมดหรือแต่บางส่วนแห่งสัญญานี้ไปจ้างช่วงอีกทอดหนึ่ง เว้นแต่ได้รับ"
            "อนุญาตเป็นหนังสือจากผู้ว่าจ้างแล้ว หากฝ่าฝืนต้องชำระค่าปรับในอัตราร้อยละ ๑๐ ของวงเงินงานที่จ้างช่วง",
       align="justify", indent=1.25)
    _p(doc, "๖. การส่งมอบงานและการจ่ายเงิน แบ่งจ่ายตามงวดงาน ดังนี้", indent=1.25)
    if insts:
        for i in insts:
    ...
    _p(doc, "๘. เอกสารแนบท้ายใบสั่งจ้าง : ขอบเขตของงาน (TOR) และใบเสนอราคา",
...
def render_tor_doc(rnd, school, doc=None) -> str:
    ...
    รูปแบบตามแบบฟอร์มจริงของโรงเรียน (๙ หัวข้อ + ลงชื่อคณะกรรมการจัดทำ TOR)"""
    doc, own = _begin(doc)
    prog = rnd.program
    sname = _school_disp(school)
    total = round(float(rnd.amount or 0), 2)
    ...
    lvl = ("ระดับชั้นอนุบาล ถึงระดับชั้นมัธยมศึกษาปีที่ ๓ ในโรงเรียนขยายโอกาส"
           if t2 else "ระดับชั้นอนุบาล ถึงระดับชั้นประถมศึกษาปีที่ ๖")
    ...
    _p(doc, "ประเทศไทยได้ให้ความสำคัญกับการจัดการอาหาร จึงได้กำหนดยุทธศาสตร์การจัดการด้านอาหารของประเทศไทย "
            "ที่สอดรับกับยุทธศาสตร์ชาติ ๒๐ ปี เชื่อมโยงการดำเนินงานทุกมิติที่เกี่ยวข้องกับอาหารสู่โภชนาการ "
    ...
    for s in ["๑. เพื่อให้นักเรียนได้รับประทานอาหารกลางวัน ที่มีคุณค่า และเพียงพอต่อความต้องการของร่างกาย",
              "๒. เพื่อช่วยเหลือนักเรียนที่ขาดแคลนและยากจน ให้ได้รับประทานอาหารกลางวันทุกคน",
              "๓. เพื่อให้นักเรียนมีสุขนิสัยที่ดีในการรับประทานอาหาร",
              "๔. เพื่อสนับสนุนกิจกรรมการเรียนการสอนกลุ่มการงานอาชีพ"]:
        _p(doc, s, indent=1, after=0)

    # ---------- ๓. คุณสมบัติของผู้เสนอราคา ----------
    _p(doc, "๓. คุณสมบัติของผู้เสนอราคา (กำหนดตามแบบที่กรมบัญชีกลางกำหนด)", bold=True, indent=0.5, after=0)
    _p(doc, "(๑) คุณสมบัติตามกฎหมาย (มาตรา ๖๔ แห่งพระราชบัญญัติการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ "
            "พ.ศ. ๒๕๖๐) ผู้จะเข้ายื่นข้อเสนอในการจัดซื้อจัดจ้างของหน่วยงานของรัฐ อย่างน้อยต้องมีคุณสมบัติ "
            "และไม่มีลักษณะต้องห้าม ดังต่อไปนี้", align="justify", indent=1, after=0)
    for s in ["(๑.๑) มีความสามารถตามกฎหมาย",
              "(๑.๒) ไม่เป็นบุคคลล้มละลาย",
              "(๑.๓) ไม่อยู่ระหว่างเลิกกิจการ",
              "(๑.๔) ไม่เป็นบุคคลซึ่งอยู่ระหว่างถูกระงับการยื่นข้อเสนอหรือทำสัญญากับหน่วยงานของรัฐ ตามมาตรา ๑๐๖ วรรคสาม",
              "(๑.๕) ไม่เป็นบุคคลซึ่งถูกแจ้งเวียนชื่อให้เป็นผู้ทิ้งงานของหน่วยงานของรัฐ ตามมาตรา ๑๐๙",
              "(๑.๖) คุณสมบัติหรือลักษณะต้องห้ามอื่นตามที่คณะกรรมการนโยบายประกาศกำหนดในราชกิจจานุเบกษา"]:
        _p(doc, s, indent=1.5, after=0)
    _p(doc, "(๒) คุณสมบัติตามที่คณะกรรมการนโยบายการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐกำหนด "
            "(หนังสือด่วนที่สุด ที่ กค (กนบ) ๐๔๐๕.๒/ว ๔๑๐ ลงวันที่ ๒๔ ตุลาคม ๒๕๖๐)",
       align="justify", indent=1, after=0)
    for s in ["๑. มีความสามารถตามกฎหมาย    ๒. ไม่เป็นบุคคลล้มละลาย    ๓. ไม่อยู่ระหว่างเลิกกิจการ",
              "๔. ไม่อยู่ระหว่างถูกระงับการยื่นข้อเสนอหรือทำสัญญากับหน่วยงานของรัฐไว้ชั่วคราว",
              "๕. ไม่เป็นผู้ทิ้งงานตามบัญชีรายชื่อผู้ทิ้งงานในระบบเครือข่ายสารสนเทศของกรมบัญชีกลาง",
              "๖. มีคุณสมบัติและไม่มีลักษณะต้องห้ามตามที่คณะกรรมการนโยบายฯ กำหนดในราชกิจจานุเบกษา",
              "๗. เป็นบุคคลธรรมดาหรือนิติบุคคลผู้มีอาชีพรับจ้างงานที่จัดจ้างในครั้งนี้",
              "๘. ไม่เป็นผู้มีผลประโยชน์ร่วมกันกับผู้ยื่นข้อเสนอรายอื่น",
              "๙. ไม่เป็นผู้ได้รับเอกสิทธิ์หรือความคุ้มกันซึ่งอาจปฏิเสธไม่ยอมขึ้นศาลไทย"]:
        _p(doc, s, indent=1.5, after=0)

    # ---------- ๔. ขอบเขตการดำเนินงาน ----------
    _p(doc, "๔. ขอบเขตการดำเนินงาน", bold=True, indent=0.5, before=2, after=0)
    _p(doc, f"ผู้รับจ้างต้องเป็นผู้รับผิดชอบการประกอบอาหารกลางวัน (ปรุงสำเร็จ) ประจำภาคเรียนที่ {term} "
            ...
            f"ให้แก่นักเรียน{lvl} ภายในวงเงิน {_money(total)} บาท ({bahttext(total)}) โดยผู้รับจ้างต้อง"
    ...
    _p(doc, "ทั้งนี้ การประกอบอาหารในแต่ละวันจะต้องเป็นรายการตามเมนู Thai School Lunch โดยโรงเรียนจะกำหนดให้"
            ...
            "(ปรุงสำเร็จ) อย่างน้อย ๕ วันทำการ", align="justify", indent=1)

    # ---------- ๕. การส่งมอบงาน ----------
    _p(doc, "๕. การส่งมอบงาน", bold=True, indent=0.5, after=0)
    ...
    # ---------- ๖. หลักเกณฑ์ ----------
    _p(doc, "๖. หลักเกณฑ์การพิจารณาคัดเลือกข้อเสนอ", bold=True, indent=0.5, after=0)
    _p(doc, "เกณฑ์ราคา", indent=1)

    # ---------- ๗. วงเงินงบประมาณ ----------
    _p(doc, "๗. วงเงินงบประมาณ", bold=True, indent=0.5, after=0)
    _p(doc, f"ภาคเรียนที่ {term} ปีการศึกษา {prog.year} รอบ {rnd.seq} ระหว่างวันที่ {ds} ถึงวันที่ {de} "
            f"จำนวน {days} วัน ได้รับจัดสรรงบประมาณจาก{fund} จำนวน {_money(total)} บาท ({bahttext(total)}) "
    ...
    _p(doc, "๘. งวดงานและการจ่ายเงิน", bold=True, indent=0.5, before=2, after=0)
    ...
    # ---------- ๙. ค่าปรับ ----------
    _p(doc, "๙. ค่าปรับ ๐.๒๐", bold=True, indent=0.5, before=2, after=0)
    _p(doc, "อ้างอิงตามหนังสือคณะกรรมการวินิจฉัยปัญหาการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ "
            "ที่ กค (กวจ) ๐๔๐๕.๒/ว ๑๑๖ ลงวันที่ ๑๒ มีนาคม ๒๕๖๒ เรื่องแนวทางปฏิบัติในการจัดซื้อวัตถุดิบ "
            "เพื่อใช้ในการประกอบอาหาร การจ้างบุคคลเพื่อประกอบอาหาร หรือการจ้างเหมาประกอบอาหาร (ปรุงสำเร็จ) "
            "ข้อ ๔ การกำหนดค่าปรับในสัญญาหรือข้อตกลง", align="justify", indent=1, after=10)

    # ---------- ลงชื่อคณะกรรมการจัดทำ TOR ----------
    _tor_committee_signs(doc, [m for m in rnd.committees if m.kind == "tor"])
...
def render_quotation_doc(rnd, school, doc=None) -> str:
    ...
    _p(doc, "3. คำเสนอนี้จะยืนอยู่เป็นระยะเวลา ๓๐ วัน นับตั้งแต่วันที่ได้ยื่นใบเสนอราคา",
       align="justify", indent=1.25, after=2)
