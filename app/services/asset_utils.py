...
# อายุการใช้งานมาตรฐาน (ปี) ตามหนังสือ สพฐ. ที่ ศธ 04002/ว1139
# (การกำหนดอายุการใช้งานและอัตราค่าเสื่อมราคาสินทรัพย์ถาวร) - ผู้ใช้แก้ได้เองรายตัว
# รายการย่อยที่อายุต่างกัน แยกเป็นคนละหมวด (เช่น การเกษตร: เครื่องมือ 3 ปี / เครื่องจักรกล 5 ปี)
CATEGORY_LIFE = {
    # อาคารและสิ่งก่อสร้าง
    "อาคารถาวร": 25,
    "อาคารชั่วคราว/โรงเรือน": 10,
    "สิ่งก่อสร้าง (คอนกรีตเสริมเหล็ก/คอนกรีตล้วน)": 15,
    "สิ่งก่อสร้าง (อื่น ๆ)": 5,
    # ครุภัณฑ์
    "ครุภัณฑ์สำนักงาน": 8,
    "ครุภัณฑ์ยานพาหนะและขนส่ง": 5,
    "ครุภัณฑ์ไฟฟ้าและวิทยุ": 5,
    "ครุภัณฑ์โฆษณาและเผยแพร่": 5,
    "ครุภัณฑ์การเกษตร (เครื่องมือและอุปกรณ์)": 3,
    "ครุภัณฑ์การเกษตร (เครื่องจักรกล)": 5,
    "ครุภัณฑ์ก่อสร้าง (เครื่องมือและอุปกรณ์)": 3,
    "ครุภัณฑ์ก่อสร้าง (เครื่องจักรกล)": 5,
    "ครุภัณฑ์งานบ้านงานครัว (เครื่องมือและอุปกรณ์)": 3,
    "ครุภัณฑ์งานบ้านงานครัว (เครื่องจักรกล)": 5,
    "ครุภัณฑ์วิทยาศาสตร์และการแพทย์": 8,
...
# สถานะครุภัณฑ์ - ล้อตามช่องในแบบบัญชีพัสดุชำรุด (ข้อ 215) เพื่อให้ติ๊กช่องให้อัตโนมัติได้
# "ใช้งาน" คือค่าปกติเดิมของระบบ (เท่ากับช่อง "ใช้อยู่" ในแบบฟอร์ม)
ASSET_STATUSES = ["ใช้งาน", "ชำรุด", "เสื่อมสภาพ", "สูญไป", "ไม่ใช้", "จำหน่ายแล้ว"]

# สถานะ -> ช่องที่ต้องติ๊กในบัญชีพัสดุชำรุด
ASSET_STATUS_COL = {"ชำรุด": "ชำรุด", "เสื่อมสภาพ": "เสื่อม", "สูญไป": "สูญไป",
                    "ไม่ใช้": "ไม่ใช้", "จำหน่ายแล้ว": "จำหน่าย", "ใช้งาน": "ใช้อยู่"}

# สถานะที่ต้องขึ้นในบัญชีพัสดุชำรุด/ไม่จำเป็นต้องใช้
ASSET_BAD_STATUSES = ["ชำรุด", "เสื่อมสภาพ", "สูญไป", "ไม่ใช้"]
