...
def _w119_box_t1(doc, *, officer, director_line, total_txt, baht_txt, advance_payer,
                 budget_kind, budget_other, director, director_office):
    """กล่องความเห็น ว.119 ตาราง 1 — ตาราง 2×2 มีเส้นขอบ (ตาม template)
    ...
    _cell_ml(t.rows[1].cells[0], [
        ...
        (f"     งบ  {RAD(budget_kind=='รายหัว')} รายหัว   {RAD(budget_kind=='15 ปี')} 15 ปี   "
         f"{CHK(budget_kind=='อื่นๆ')} อื่นๆ {budget_other or '.........................'}", "left", False),
        ("", "left", False),
        ("(ลงชื่อ)..............................เจ้าหน้าที่พัสดุ", "left", False),
        ("(ลงชื่อ)..............................หัวหน้าเจ้าหน้าที่", "left", False),
    ])
    _cell_ml(t.rows[1].cells[1], [
