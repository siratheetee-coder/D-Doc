...
def _w119_box(doc, *, responsible, director_line, total_txt, baht_txt, advance_payer, fin,
    ...
    _fill_cell(t.rows[0].cells[1], [
        ...
        # ตาราง 2 ไม่ใช่การจัดซื้อจัดจ้าง จึงไม่มีข้อ "ให้ความเห็นชอบการจัดซื้อจัดจ้าง"
        (("๑. ค่าใช้จ่ายรายการนี้เป็นไปตามตารางที่ 2 ว.119 ไม่ต้องจัดซื้อจัดจ้าง"
          if table2 else "๑. ให้ความเห็นชอบการจัดซื้อจัดจ้างดังกล่าวข้างต้น"), "left", False),
