...
MIGRATIONS = [
    ("textbook_purchase", "meet_no", "INTEGER DEFAULT 1"),
    ("textbook_purchase", "attendees", "TEXT"),
    ("textbook_purchase", "meet_checker", "VARCHAR DEFAULT ''"),
    ...
    ("travel_request", "budget_words", "VARCHAR DEFAULT ''"),
    ("travel_request", "purpose_type", "VARCHAR DEFAULT ''"),
    ("travel_request", "purpose_other", "VARCHAR DEFAULT ''"),
    ("travel_request", "doc_ref", "VARCHAR DEFAULT ''"),
    ("travel_request", "doc_date", "DATE"),
    ("travel_request", "reimburse", "VARCHAR DEFAULT ''"),
    ("travel_request", "cost_types", "VARCHAR DEFAULT ''"),
    ("travel_request", "car_plate", "VARCHAR DEFAULT ''"),
    ("travel_request", "cost_other", "VARCHAR DEFAULT ''"),
    ("travel_request", "substitute_person_id", "INTEGER"),
    ("travel_request", "doc_attachment", "BLOB"),
    ("travel_request", "doc_attachment_name", "VARCHAR DEFAULT ''"),
    ...
    ("leave_request", "attachment", "BLOB"),
    ("leave_request", "attachment_name", "VARCHAR DEFAULT ''"),
    ("travel_request", "attachment", "BLOB"),
    ("travel_request", "attachment_name", "VARCHAR DEFAULT ''"),
