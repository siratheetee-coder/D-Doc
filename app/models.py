...
class LunchProgram(Base):
    ...
    cook_wage = Column(Float, default=0.0)          # ค่าจ้างแม่ครัว (จ้างบุคคล) - หักจากงบรายหัว เหลือ=ค่าวัตถุดิบ
...
class LunchHireRound(Base):
    ...
    cook_wage = Column(Float, default=0.0)           # ค่าจ้างแม่ครัวต่อรอบ (หักต่อรอบ)
...
class TextbookPurchase(Base):
    ...
    meet_no = Column(Integer, default=1)               # รายงานการประชุม ครั้งที่
    attendees = Column(Text, default="")               # รายชื่อกรรมการผู้เข้าประชุม (JSON list)
    meet_checker = Column(String, default="")          # ผู้ตรวจบันทึกการประชุม
